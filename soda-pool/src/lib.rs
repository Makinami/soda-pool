...
//! broken endpoints.
//!
//! For more detailed explanation of the internal workings of the pool, please see the [implementation details](#implementation-details).
//!
//! # Usage
//!
//! Although this crate is designed to be used by gRPC clients generated by [`soda-pool-build`] crate, it can also be used directly.
//!
//! ```should_panic
//! # use std::error::Error;
...
//! # }
//!
//! // This is just a placeholder for the actual gRPC request.
...
//!    new channels.
//!
//!    Frequency of this check can be configured using [`ChannelPoolBuilder::dns_check_interval`](crate::ChannelPoolBuilder::dns_interval) method.
//!    The default is 5 seconds.
//!
//! 2. A task that periodically checks connections previously marked as broken
//!    and tries to reconnect them.
//!
//!    Frequency of this check is calculated on per IP basis following the exponential backoff algorithm.
//!    The backoff time will range from 1 to approximately 60 seconds.
//!
