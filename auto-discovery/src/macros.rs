...
macro_rules! define_client {
    ($client_type:ident) => {
        ...
        impl $client_type {
            ...
            async fn get_channel(&self) -> Result<(std::net::IpAddr, tonic::transport::Channel), $crate::error::WrappedClientError> {
                self.base.get_channel().await
            }

            async fn report_broken(&self, ip_address: std::net::IpAddr) -> Result<(), $crate::error::WrappedClientError> {
