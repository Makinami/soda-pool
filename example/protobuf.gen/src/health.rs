...
pub mod health_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut().insert(GrpcMethod::new("health.Health", "IsAlive"));
...
pub mod echo_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn echo_message(
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("health.Echo", "EchoMessage"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut().insert(GrpcMethod::new("health.Echo", "EchoStream"));
                ...
                "/health.Health/IsAlive" => {
                    ...
                    impl<T: Health> tonic::server::UnaryService<()> for IsAliveSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            ...
                            let fut = async move {
                                <T as Health>::is_alive(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/health.Echo/EchoMessage" => {
                    ...
                    for EchoMessageSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Echo>::echo_message(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/health.Echo/EchoStream" => {
                    ...
                    for EchoStreamSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Echo>::echo_stream(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
